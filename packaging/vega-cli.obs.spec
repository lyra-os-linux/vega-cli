...
# packaging/vega-cli.spec adaptada só no Source0/%setup pra bater com o
...
Source0:        vega-cli-src-%{version}.tar
BuildArch:      noarch
...
%prep
%setup -q -n vega-cli-src-%{version}
